...
#    printf STDERR "  -u userid     Send autoresult to Autoresult as userid\n";
    die "\n";
}
...
#
# Optionally send the autoresult to the Autolab server if the driver
...
# Post the autoresult to Autolab.
&Driverlib::driver_post($userid, $autoresult, $autograded);
